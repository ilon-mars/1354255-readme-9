...
export async function fillAuthorInfo(httpService: HttpService, record: Post | Comment) {
  ...
  try {
    ...
    console.log(`Failed to get author data for author with id ${record.authorId}`);
  }
